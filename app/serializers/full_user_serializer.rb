class FullUserSerializer < ActiveModel::Serializer
  ...
  attributes :id, :email, :first_name, :last_name, :day_off_infos, :birthdate, :join_date, :status, :phone_number, :roles, :total_paid_days_off, :total_non_paid_days_off, :salary_per_month, :certificate
